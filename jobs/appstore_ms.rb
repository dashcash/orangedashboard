...
SCHEDULER.every '5m', :first_in => 0 do |job|
  ...
  ratings_res = client.get("http://itunes.apple.com/lookup?id=#{MS_APP_ID}&country=#{MS_APP_COUNTRY}")
  ...
  reviews_res = client.get("https://itunes.apple.com/#{MS_APP_COUNTRY}/rss/customerreviews/id=#{MS_APP_ID}/sortBy=mostRecent/json")
